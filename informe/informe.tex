...
\section{Resultados}
\begin{figure}[h]
  \includegraphics[scale=0.2]{img/ejemplo1.png}
  \includegraphics[scale=0.2]{img/ejemplo2.png}
  \includegraphics[scale=0.2]{img/ejemplo3.png}
  \includegraphics[scale=0.2]{img/ejemplo4.png}
  \includegraphics[scale=0.2]{img/ejemplo6.png}
\end{figure}
